class ReservationsController < ApplicationController
  ...
  def create
    ...
    if current_user == room.user
      redirect_to room, notice: "You can't book your own room!"
    else
      ...
      if @reservation
        values = {
          ...
          cmd: '_xclick',
          upload: 1,
          notify_url: 'http://cb48685c.ngrok.io/notify',
          amount: @reservation.total,
          item_name: @reservation.room.listing_name,
          item_number: @reservation.id,
          quantity: '1',
          return: 'http://cb48685c.ngrok.io/your_trips'
        }

        redirect_to "https://www.sandbox.paypal.com/cgi-bin/webscr?" + values.to_query
      else
        redirect_to @reservation.room, alert: "Your reservation can't be made.."
      end
    end
  end
